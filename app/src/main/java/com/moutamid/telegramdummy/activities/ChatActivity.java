...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.send.setOnClickListener(v -> send(binding.message.getText().toString().trim() + "\t\t\t", false, binding.message.getText().toString()));
        binding.receive.setOnClickListener(v -> receive(binding.message.getText().toString().trim() + "\t\t", false, binding.message.getText().toString()));
